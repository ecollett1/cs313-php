<?php
    ...
    $query = "SELECT name, birthday, pictureUrl FROM actor a INNER JOIN movieActor ma ON a.id = ma.actorId INNER JOIN movies m ON m.id = ma.movieId WHERE m.title = :movie_title";
